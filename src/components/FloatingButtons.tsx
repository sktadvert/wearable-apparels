...
const socials = [
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/wearableapparels",
    bg: "#1877F2",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
  ...
  {
    name: "TikTok",
    href: "https://tiktok.com/@wearable_apparels",
    bg: "#000000",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
...
export default function FloatingButtons() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[999] flex flex-col-reverse items-end gap-3">
      ...
      <a
        href="mailto:info@wearableapparels.com"
        className="w-14 h-14 rounded-full bg-[#006837] flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
        title="Email: info@wearableapparels.com"
      >
      ...
      <button
        ...
        className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-all ${
          expanded ? "bg-slate-700 rotate-45" : "bg-slate-800"
        }`}
        title={expanded ? "Close" : "Follow Us"}
      >
